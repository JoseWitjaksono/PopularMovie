...
import id.sch.smktelkom_mlg.privateassignment.xirpl634.popularmovie.model.ArticlesResponse;
...
public class ArticlesActivity extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setTitle(getIntent().getStringExtra(Section1Fragment.SOURCENAME));
    ...
    {
        String id = getIntent().getStringExtra(Section1Fragment.SOURCEID);
